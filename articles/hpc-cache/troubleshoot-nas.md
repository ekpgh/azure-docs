...
In some cases, changing the MTU setting for the Azure HPC Cache to 1400 can help. However, if your back-end storage system sends packets larger than 1400 bytes, the cache will reject these packets. Read [Configure additional Azure HPC Cache settings](configuration.md) for details.
